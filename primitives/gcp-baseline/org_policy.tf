# Org Policy requires org-level permissions not available in standalone projects.
# These policies would be applied at the org or folder scope in a production environment.
